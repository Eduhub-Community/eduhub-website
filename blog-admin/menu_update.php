...
$catShow = "SELECT * FROM  menu WHERE id = $id";
...
if(isset($_POST['catBtn'])){
    ...
    $menuURLUp = $_POST['menuUrl'];

    $catUpe =  "UPDATE `menu` SET `name` = '$catNameUp', `action` = '$menuURL' WHERE `menu`.`id` = '$id';";
...
<form action="" method="post" id="cat_name">
  ...
  <input type="text" name="menuUrl"  class="form-control" value="<?= $catArr['action']?>">
